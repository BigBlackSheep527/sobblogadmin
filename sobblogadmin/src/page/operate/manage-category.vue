            ...
            <el-table
                ...
                <el-table-column label="操作">
                    <template slot-scope="scope" >
                        ...
                        <span v-if="scope.row.status==='0'"><el-button @click="del(scope.row)" type="danger" size="mini" disabled>删除</el-button></span>
                        <span v-if="scope.row.status==='1'"><el-button @click="del(scope.row)" type="danger" size="mini">删除</el-button></span>
                    </template>
                </el-table-column>
            </el-table>
        </div>
