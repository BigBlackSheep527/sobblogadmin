                ...
                <el-table-column label="操作">
                    <template slot-scope="scope" >
                        ...
                        <span v-if="scope.row.state==='0'">
                            <el-button @click="del(scope.row)" type="danger" size="mini" disabled>删除</el-button>
                        </span>
                        <span v-else><el-button @click="del(scope.row)" type="danger" size="mini">删除</el-button></span>
                    </template>
                </el-table-column>
            </el-table>
        </div>
    ...
    export default {
        ...
        methods:{
            ...
            addLoop(){
                ...
                console.log("轮播图id为"+this.loop.id)
                if (this.loop.id === '') {
