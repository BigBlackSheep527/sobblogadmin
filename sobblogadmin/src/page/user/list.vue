...
<!--                         <el-image :src="" class="user-image"></el-image>-->
                 ...
                 <el-table-column
                    ...
                    >
                     <template slot-scope="scope" >
                         <el-button @click="ret_p(scope.row)" type="text" size="mini">重置密码</el-button>
                         <span v-if="scope.row.state==='0'">
                            <el-button @click="edit(scope.row)"  size="mini" >恢复</el-button>
                        </span>
                         <span v-else><el-button @click="edit(scope.row)" type="danger" size="mini">删除</el-button></span>
        ...
        <!--重置密码-->
         <el-dialog
             ...
             <el-form  status-icon  ref="ruleForm" label-width="100px" class="demo-ruleForm" >
                 ...
                 <el-form-item>
                     <el-button @click="retPassword(ret.tarPassword,ret.checkPassword,ret.deleteTargetId)" type="primary">提交</el-button>
